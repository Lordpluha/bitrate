...
- 0665062: `docker-compose.prod.yaml`'s `api` service `environment:` list is an explicit allowlist —
...
- eb48b85: Fixed the admin panel's login failing in production with a CORS preflight rejection
