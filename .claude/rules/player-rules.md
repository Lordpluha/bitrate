...
`import type … from 'svelte'`. See `.claude/rules/architecture-checklist.md` § "Player-1".
...
`.claude/rules/code-style.md` § "Keeping Biome out of the ESLint apps takes `files.includes`,
