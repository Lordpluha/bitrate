# styling: detailed guidance

Read only the section needed for this task. The scoped rule
[../rules/styling.md](../rules/styling.md) owns the concise requirements.
...
4. Review component complexity using `code-principles.md`; line count alone is not a failure.
