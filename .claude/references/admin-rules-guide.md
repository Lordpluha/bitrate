# admin-rules: detailed guidance

Read only the section needed for this task. The scoped rule
[../rules/admin-rules.md](../rules/admin-rules.md) owns the concise requirements.
...
`.claude/references/verification.md` demands of the Biome nursery rules: write a file that violates the
