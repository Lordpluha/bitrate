---
name: impeccable
description: "Design, review or improve frontend UI/UX: layout, typography, accessibility, responsive behavior, motion, copy and design systems. Use for visual work, not backend-only tasks."
version: 4.1.1
user-invocable: true
